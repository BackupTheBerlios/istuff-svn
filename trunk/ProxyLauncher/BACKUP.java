...
public class BACKUP extends JFrame implements WindowListener, ServiceListener {
...
/*
	...
	private void createMenuBar() {
	    ...
	    ActionListener selectNewFile = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// TODO: Add a confirmation dialog to eventually save the current composition
				// maybe also a flag justSaved?
				removeAllTabs();
			}
		};
		ActionListener selectOpenFile = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//TODO: Add a dialog to save the current composition
				// add possibility to add a file to current composition
		...
		ActionListener selecPreferences = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new PreferencesDialog();
			}
		};
			
		ActionListener selectProxyDirDialog = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	//			searchDirectoriesDialog();
			}
		};
		...
		fileMenu.addSeparator();
		(fileMenu.add(chooseDir)).addActionListener(selectProxyDirDialog);
		fileMenu.addSeparator();
		(fileMenu.add(preferences)).addActionListener(selecPreferences);
		fileMenu.addSeparator();
