...
@interface AccelerometerPatch (QCInspector)
...
+ (Class)inspectorClassWithIdentifier:(id)fp8
{
	return [AccelerometerPatchUI class];
}
...
- (id)initWithIdentifier:(id)fp8
{
	...
	NSLog (@"Initializing AccelerometerPatch");
	...
	NSLog(@"About to create EH for Accelerometer");
...
- (void) waitForEvents
{
	...
	// invoke the waitForEvent operation, keep the returned event in a smart pointer
		...
		NSLog(@"AccelerometerPatch received");
		// print debug info
