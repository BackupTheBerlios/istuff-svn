...
#import "ProcessorPatchTemplate.h"


@implementation ProcessorPatchTemplate

/*
Only change the UI class if there is a new UI file attached.
Otherwise a standard iStuffUI class will be taken.

@interface ProcessorPatchTemplate (QCInspector)
+ (Class)inspectorClassWithIdentifier:(id)fp8;
@end

@implementation ProcessorPatchTemplate (QCInspector)
