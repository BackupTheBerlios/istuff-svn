User's Guide
Teleo Multi IO Module with iStuff framework
...
For more information about how to connect see http://www.makingthings.com/products/documentation/teleo_multi_io_user_guide/index.html#5_2
...
For more information about how to connect see http://www.makingthings.com/products/documentation/teleo_multi_io_user_guide/index.html#5_3
...
For more information about how to connect see http://www.makingthings.com/products/documentation/teleo_multi_io_user_guide/index.html#5_4
...
For more information about how to connect see http://www.makingthings.com/products/documentation/teleo_multi_io_user_guide/index.html#5_5
...
First of all go to the directory ~/iStuff Framework v1.3beta/Hardware Proxies/Teleo/Mac OS X , you can find iteleo.cpp there which you need to build it and run it. Open a new Shell and change path to ~/iStuff Framework v1.3beta/Hardware Proxies/Teleo/Mac OS X/build and type ./iteleo -server localhost -name <the name of this event client> -ain0
If you are using the port number 0 of analogue input.
For other existing options you can use the following options:

iteleo [-server server_name] [-device usb_device] [-ain #] [-din #] [-pwmout #] [-dout #]
